                      ...
                      <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                          <div class="active tab-pane" id="editprofile">
                              <form method="post" action="PicUpdateServlet" enctype="multipart/form-data" name="form1">
                                  <!--
                                  ...
                                  -->
                                  <div class="form-group">
                                    <label for="ProfilePictureFile">Update profile picture:</label>
                                    <input type="file" required="required" name="file" id="ProfilePictureFile">

                                    <p class="help-block">Upload your profile picture. Use 160x160 px picture for best results or your image will automatically be converted into this size.</p>
                                  </div>
