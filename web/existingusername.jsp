    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <p class="login-box-msg"><small style="color: red;">Sorry this new user registration is invalid.</small></p>
                ...
                <br>
                <a href="ForgotPassword.jsp" class="text-center" style="margin-left:32%;">Password Assistance</a><br>
            </div>
            <!-- /.login-box-body -->
        </div>
        <!-- /.login-box -->
