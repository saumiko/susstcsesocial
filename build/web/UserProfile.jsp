...
<html>
    ...
    <%
        ...
        String disUsrPhoto = myImage.getMyImage(Integer.parseInt(ProfileID));
        String disUsrName = userInfo.getName(Integer.parseInt(ProfileID));
        String disUsrType = userInfo.getUserType(Integer.parseInt(ProfileID));
    %>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <img class="profile-user-img img-responsive img-circle" src="<%=disUsrPhoto%>" alt="User profile picture">

                                    <h3 class="profile-username text-center"><%=disUsrName%></h3>

                                    <p class="text-muted text-center"><%=disUsrType%></p>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <p class="text-muted">
                                        <%=userInfo.getUserSemester(Integer.parseInt(ProfileID))%>
                                    </p>
                                    ...
                                    <p class="text-muted"><%=userInfo.getUserReg(Integer.parseInt(ProfileID))%></p>

                                    <hr>

                                    <strong><i class="fa fa-envelope margin-r-5"></i> SUSTian E-mail</strong>

                                    <p class="text-muted"><%=userInfo.getUserMail(Integer.parseInt(ProfileID))%></p>

                                    <hr>

                                    <strong><i class="fa fa-calendar-check-o margin-r-5"></i> Date of Birth</strong>

                                    <p class="text-muted"><%=userInfo.getUserDOB(Integer.parseInt(ProfileID))%></p>

                                    <hr>

                                    <strong><i class="fa fa-heart margin-r-5"></i> Blood Group</strong>

                                    <p class="text-muted"><%=userInfo.getUserBlood(Integer.parseInt(ProfileID))%></p>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                        <h3>Personality Score: <%=SinglePost.getPersonalityScore(Integer.parseInt(ProfileID))%>%</h3><br>
                                        <!-- Post -->
                                        <%
                                            int totalUsrPosts = SinglePost.getUserPostNumber(Integer.parseInt(ProfileID));
                                        %>
                                        <%for(int i = 0;i<totalUsrPosts;i++){%>
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm" src="<%=disUsrPhoto%>" alt="user image">
                                                <span class="username">
                                                    <a href="UserProfile.jsp?id=<%=ProfileID%>"><%=disUsrName%></a>
                                                </span>
                                            </div>
                                            <!-- /.user-block -->
                                            <p>
                                                <%=SinglePost.getUserPosts(Integer.parseInt(ProfileID), i)%>
                                            </p>
